...
A three-phase system for taking a resume from raw to ready-to-submit.
...
| **2B — Full ATS Optimize** | Want deep keyword scoring + audit | Canonical file + JD | `resume-[company].md` + keyword report |
